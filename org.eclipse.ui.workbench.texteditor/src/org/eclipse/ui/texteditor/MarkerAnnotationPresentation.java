...
/**
 * Annotation presentation for marker annotations 
 * This class may be instantiated or be subclassed.
 *
 * @see org.eclipse.ui.texteditor.MarkerAnnotation
 */
public class MarkerAnnotationPresentation extends AnnotationPresentation  {
	 ...
	 *
	 * @param markerAnnotation the marker annotation
	 */
	public MarkerAnnotationPresentation(MarkerAnnotation markerAnnotation) {
		Assert.isNotNull(markerAnnotation);
		fMarker= markerAnnotation.getMarker();
		initialize();
	}
	...
	/**
	 * Informs this presentation about changes applied to its underlying marker
	 * and adapts to those changes.
	 */
	public void update() {
		// TODO need annotation model listener to call this method
		initialize();
	}
