...
public final class DefaultPhoneticDistanceAlgorithm implements IPhoneticDistanceAlgorithm {
	...
	private static final int COST_CASE= 10;

	/** The insert character cost */
	private static final int COST_INSERT= 95;

	/** The remove character cost */
	private static final int COST_REMOVE= 95;

	/** The substitute characters cost */
	private static final int COST_SUBSTITUTE= 100;

	/** The swap characters cost */
	private static final int COST_SWAP= 90;
